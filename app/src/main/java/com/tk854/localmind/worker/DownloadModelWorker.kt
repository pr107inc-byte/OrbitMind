package com.tk854.localmind.worker
...
import com.tk854.localmind.core.storage.StoredModelRef
...
class DownloadModelWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): ListenableWorker.Result {
        ...
        try {
            ...
            // SECURITY FIX: model name not logged in release â€” use SecureLogger
            SecureLogger.i(
                "LocalMind-Download",
    ...
    private fun createForegroundInfo(
        ...
        val cancelIntent = Intent(applicationContext, com.tk854.localmind.receiver.DownloadActionReceiver::class.java).apply {
            action = com.tk854.localmind.receiver.DownloadActionReceiver.ACTION_CANCEL_DOWNLOAD
            putExtra(com.tk854.localmind.receiver.DownloadActionReceiver.EXTRA_MODEL_ID, modelId)
        }
        ...
        val openIntent = Intent(applicationContext, com.tk854.localmind.MainActivity::class.java).apply {
