package com.tk854.localmind.data.local

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.migration.Migration
import androidx.sqlite.db.SupportSQLiteDatabase
import com.tk854.localmind.data.local.dao.ConversationDao
import com.tk854.localmind.data.local.dao.DownloadTaskDao
import com.tk854.localmind.data.local.dao.MessageDao
import com.tk854.localmind.data.local.dao.ModelDao
import com.tk854.localmind.data.local.dao.PersonaDao
import com.tk854.localmind.data.local.entity.ConversationEntity
import com.tk854.localmind.data.local.entity.DownloadTaskEntity
import com.tk854.localmind.data.local.entity.MessageEntity
import com.tk854.localmind.data.local.entity.MessageFtsEntity
import com.tk854.localmind.data.local.entity.ModelEntity
...
import com.tk854.localmind.data.local.dao.PromptTemplateDao
...
abstract class LocalMindDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         * Adds:
         *  1. conversations.isPinned       â€” pin to top
         *  2. conversations.personaId      â€” link to persona
         *  3. conversations.totalTokens    â€” running token sum
         *  4. conversations.lastMessagePreview â€” cached preview
         *  5. conversations.lastMessageRole    â€” "user"/"assistant"
         *  6. message_fts FTS4 virtual table   â€” full-text search
         */
        val MIGRATION_13_14 = object : Migration(13, 14) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                // content="" means external content table â€” keeps DB size small
                db.execSQL("""
        ...
        val MIGRATION_17_18 = object : Migration(17, 18) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // PocketPal-style: supportsThinking column — model load ke baad chat template check se set hota hai.
                // Default false — purane models ke liye safe, naya model load hone par detect hoga.
                db.execSQL("ALTER TABLE models ADD COLUMN supportsThinking INTEGER NOT NULL DEFAULT 0")
            }
        }

        val MIGRATION_16_17 = object : Migration(16, 17) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Add thinkingDurationSec column to messages table.
                // Used to show "Thought for Xs" in ThinkingBubble for reasoning models.
                db.execSQL("ALTER TABLE messages ADD COLUMN thinkingDurationSec INTEGER DEFAULT NULL")
            }
        }
        ...
        val MIGRATION_14_15 = object : Migration(14, 15) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                // Room generates a different CREATE INDEX statement, causing schema mismatch â†’ crash.
