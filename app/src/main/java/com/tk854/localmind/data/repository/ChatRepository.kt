...
import com.tk854.localmind.data.local.LocalMindDatabase
import com.tk854.localmind.data.local.dao.ConversationDao
import com.tk854.localmind.data.local.dao.ModelUsageStat
...
import com.tk854.localmind.data.mapper.toDomain
import com.tk854.localmind.data.mapper.toEntity
...
import com.tk854.localmind.llm.HybridInferenceRouter
import com.tk854.localmind.llm.InferenceConfig
import com.tk854.localmind.llm.InferenceRouteHint
import com.tk854.localmind.llm.InferenceTelemetry
...
class ChatRepository @Inject constructor(
    ...
    fun isEngineLocked(): Boolean = llmEngine.isMutexLocked()
    ...
    suspend fun searchMessages(query: String, limit: Int = 50): List<Message> {
        ...
        return try {
            // FTS4 query â€” sanitize to avoid SQLite FTS syntax errors
     ...
     * Faster than full recalculation â€” called after each message save.
     */
    ...
    /**
     * Get recent messages across all conversations â€” for global history view.
     */
