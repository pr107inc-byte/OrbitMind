...
import com.tk854.localmind.core.storage.InternalModelStorageManager
...
class ModelRepository @Inject constructor(
    ...
    // PocketPal-style: model load hone ke baad chat template se supportsThinking detect karke update karo
    suspend fun updateSupportsThinking(modelId: String, supportsThinking: Boolean) {
        val entity = modelDao.getModelById(modelId) ?: return
        modelDao.updateModel(entity.copy(supportsThinking = supportsThinking))
    }
    ...
    suspend fun importModel(uri: android.net.Uri, name: String): Result<Model> {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val inferredTemplateId = com.tk854.localmind.llm.prompt.TemplateCatalog
                ...
                val entity = ModelEntity(
                    ...
                    recommendedTopK = 40,
                    recommendedRepeatPenalty = 1.15f,
                ...
                if (com.tk854.localmind.BuildConfig.DEBUG) android.util.Log.w("ModelRepository", "error", e)
                Result.failure(e)
            }
        }
    }
