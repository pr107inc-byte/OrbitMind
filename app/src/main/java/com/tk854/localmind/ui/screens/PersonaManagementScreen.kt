...
import com.tk854.localmind.domain.model.PersonaContextMode
import com.tk854.localmind.ui.theme.*
import com.tk854.localmind.ui.viewmodel.PersonaManagementViewModel
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    persona.systemPrompt.take(80) + if (persona.systemPrompt.length > 80) "â€¦" else "",
...
fun PersonaEditDialog(
    ...
    var icon by remember { mutableStateOf(persona?.icon ?: "ðŸ¤–") }
            ...
            Column(modifier = Modifier.padding(24.dp)) {
                ...
                Row(
                    ...
                    Surface(
                        ...
                        Box(contentAlignment = Alignment.Center) {
                            Text(icon.ifBlank { "ðŸ¤–" }, fontSize = 28.sp)
                        }
                    }
                    OutlinedTextField(
                        value = icon,
                ...
                Row(
                    ...
                    // Agar user edit kare to new UUID generate karo â€” original ko overwrite mat karo
                    val isBuiltIn = persona != null &&
                        (com.tk854.localmind.domain.model.Persona.FEATURED_PERSONAS +
                         listOf(com.tk854.localmind.domain.model.Persona.DEFAULT_ASSISTANT))
