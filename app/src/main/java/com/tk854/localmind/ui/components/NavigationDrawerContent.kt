...
fun NavigationDrawerContent(
    ...
    Column(
        ...
        Text(
            ...
            color = com.tk854.localmind.ui.theme.NeonPrimary,
                ...
                modifier = Modifier.size(24.dp)
                        ...
                        Icon(
                                imageVector = Icons.Default.Edit,
                                            ...
                                            tint = com.tk854.localmind.ui.theme.NeonTextSecondary,
                        ...
                        colors = NavigationDrawerItemDefaults.colors(
                            ...
                            selectedContainerColor = com.tk854.localmind.ui.theme.NeonPrimary.copy(alpha = 0.15f),
                            unselectedTextColor = com.tk854.localmind.ui.theme.NeonText.copy(alpha = 0.7f),
                            selectedTextColor = com.tk854.localmind.ui.theme.NeonPrimary,
                            unselectedIconColor = com.tk854.localmind.ui.theme.NeonText.copy(alpha = 0.7f),
                            selectedIconColor = com.tk854.localmind.ui.theme.NeonPrimary
                        ),
            ...
            if (recentConversations.size > 20) {
                TextButton(
                    ...
                    Text(
                        ...
                        color = com.tk854.localmind.ui.theme.NeonPrimary.copy(alpha = 0.7f),
    ...
    deletingConversation?.let { conv ->
        AlertDialog(
            ...
            title = { Text("Delete Chat?", color = com.tk854.localmind.ui.theme.NeonText) },
            text = {
                Text(
                    "\"${conv.title.ifBlank { "Untitled" }}\" permanently delete ho jaayega.",
                    color = com.tk854.localmind.ui.theme.NeonTextSecondary
                )
            },
            confirmButton = {
                Button(
            ...
            dismissButton = {
                TextButton(onClick = { deletingConversation = null }) {
                    Text("Cancel", color = com.tk854.localmind.ui.theme.NeonPrimary)
                }
            },
            containerColor = com.tk854.localmind.ui.theme.NeonSurface
        )
    }
    ...
    renamingConversation?.let { conv ->
        AlertDialog(
            ...
            title = { Text("Rename Chat", color = com.tk854.localmind.ui.theme.NeonText) },
            text = {
                OutlinedTextField(
                    value = renameText,
                    ...
                    colors = OutlinedTextFieldDefaults.colors(
                        focusedBorderColor = com.tk854.localmind.ui.theme.NeonPrimary,
                        unfocusedBorderColor = com.tk854.localmind.ui.theme.NeonTextSecondary,
                        focusedTextColor = com.tk854.localmind.ui.theme.NeonText,
                        unfocusedTextColor = com.tk854.localmind.ui.theme.NeonText
                    )
                )
            },
            confirmButton = {
                TextButton(onClick = {
                    ...
                    Text("Save", color = com.tk854.localmind.ui.theme.NeonPrimary)
                }
            },
            dismissButton = {
                TextButton(onClick = { renamingConversation = null }) {
                    Text("Cancel", color = com.tk854.localmind.ui.theme.NeonTextSecondary)
                }
            },
            containerColor = com.tk854.localmind.ui.theme.NeonSurface
        )
