...
import com.tk854.localmind.ui.components.*
import com.tk854.localmind.ui.theme.*
import com.tk854.localmind.ui.viewmodel.SettingsViewModel
...
fun SettingsScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(androidx.compose.ui.res.stringResource(com.tk854.localmind.R.string.settings_title), color = NeonText) },
                navigationIcon = {
        ...
        Column(
            ...
            // Advanced Inference (Modularized) â€” Full PocketPal parity
...
// Local components have been moved to com.tk854.localmind.ui.components.SettingsComponents.kt
