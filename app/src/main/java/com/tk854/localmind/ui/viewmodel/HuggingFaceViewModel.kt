...
import com.tk854.localmind.core.storage.StorageAdmissionManager
import com.tk854.localmind.core.utils.NetworkUtils
import com.tk854.localmind.core.utils.StorageUtils
import com.tk854.localmind.data.repository.DownloadState
import com.tk854.localmind.data.repository.HuggingFaceRepository
import com.tk854.localmind.data.repository.ModelCatalogRepository
...
import com.tk854.localmind.domain.model.ModelCompatibilityState
import com.tk854.localmind.domain.model.ModelVariantSizeSource
...
import com.tk854.localmind.ui.components.DownloadMetricsFormatter
    ...
    private fun loadCuratedModels() {
        viewModelScope.launch {
            val curated = repository.getCuratedModels().map { info ->
                ...
                com.tk854.localmind.domain.model.ModelCatalogItem(
                    id = info.id,
                    name = info.name,
                    repoId = info.repoId,
                    author = info.author,
