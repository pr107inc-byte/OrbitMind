...
if ($LASTEXITCODE -ne 0) {
    ...
    if ($installText -match "INSTALL_FAILED_UPDATE_INCOMPATIBLE") {
        ...
        & adb uninstall com.tk854.localmind | Out-Host
...
adb shell am start -n com.tk854.localmind/com.tk854.localmind.MainActivity
...
while ([string]::IsNullOrWhiteSpace($appPid)) {
    ...
    $appPid = (adb shell pidof -s com.tk854.localmind).Trim()
}
